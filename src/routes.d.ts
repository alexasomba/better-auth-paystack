...
export declare const paystackWebhook: (options: PaystackOptions) => import("better-auth").StrictEndpoint<"/paystack/webhook", {
    method: "POST";
    metadata: {
        openapi: {
            operationId: string;
...
export declare const initializeTransaction: (options: PaystackOptions) => import("better-auth").StrictEndpoint<"/paystack/transaction/initialize", {
    method: "POST";
    body: z.ZodObject<{
        plan: z.ZodString;
...
export declare const verifyTransaction: (options: PaystackOptions) => import("better-auth").StrictEndpoint<"/paystack/transaction/verify", {
    method: "GET";
    query: z.ZodObject<{
...
export declare const listSubscriptions: (options: PaystackOptions) => import("better-auth").StrictEndpoint<"/paystack/subscription/list", {
    method: "GET";
    use: (((inputContext: import("better-auth").MiddlewareInputContext<import("better-auth").MiddlewareOptions>) => Promise<{
        session: {
            session: Record<string, any> & {
...
export declare const disablePaystackSubscription: (options: PaystackOptions) => import("better-auth").StrictEndpoint<"/paystack/subscription/disable", {
    method: "POST";
    body: z.ZodObject<{
...
export declare const enablePaystackSubscription: (options: PaystackOptions) => import("better-auth").StrictEndpoint<"/paystack/subscription/enable", {
    method: "POST";
    body: z.ZodObject<{
        subscriptionCode: z.ZodString;
        emailToken: z.ZodString;
