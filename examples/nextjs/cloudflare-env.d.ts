/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareEnv ./cloudflare-env.d.ts` (hash: 7e22b017b4362e19405192f884241f6f)
// Runtime types generated with workerd@1.20260128.0 2026-02-01 global_fetch_strictly_public,nodejs_compat
declare namespace Cloudflare {
	interface Env {
		...
		WORKER_SELF_REFERENCE: Fetcher /* nextjs-better-auth-paystack */;
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "PAYSTACK_SECRET_KEY" | "PAYSTACK_WEBHOOK_SECRET">> {}
}
